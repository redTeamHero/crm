...
function applyPortalTheme(theme = {}){
  ...
  if (root) {
    ...
    root.style.setProperty('--portal-background-color', config.backgroundColor || '');
    if (config.backgroundImageUrl) {
      root.style.setProperty('--portal-background-image', `url(${JSON.stringify(config.backgroundImageUrl)})`);
    } else {
