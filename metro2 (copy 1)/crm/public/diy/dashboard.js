(() => {
  ...
  function initWizAudit() {
    ...
    btn.addEventListener('click', async function() {
      ...
      btn.disabled = true;
      btn.innerHTML = '<svg style="width:16px;height:16px;" class="animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg> Analyzing with AI\u2026 (1\u20132 min)';
      var msgEl = document.getElementById('wizAuditMsg');
      if (msgEl) { msgEl.textContent = 'Analyzing your report with AI \u2014 this usually takes 1\u20132 minutes. Please wait\u2026'; msgEl.style.display = ''; }
