...
function normalizeDashboardConfig(raw = {}) {
  ...
  const normalized = {
    ...
    ladder: {
      ...
      summaryLinkLabel: sanitizeText(
        ladder.summaryLinkLabel,
        DEFAULT_DASHBOARD_CONFIG.ladder.summaryLinkLabel,
      ),
      summaryLinkUrl: sanitizeUrl(
        ladder.summaryLinkUrl,
        DEFAULT_DASHBOARD_CONFIG.ladder.summaryLinkUrl,
        { allowEmpty: true },
      ),
    },
  };
